...
#============================================UPDATE DATAGIRDVIEW CODE======================================
    ...
    def show_student_profile_panel():
        ...
        student_status_combo.config(state='disabled')
        ...
        def save_student_data(student_id):
            ...
            try:
                cursor.execute("""
                    ...
                    SET date_added = %s, payment_status = %s, due_date=%s, amount_paid = %s, balance = %s 
                    WHERE student_id = %s
                """, (current_date_updated_sb, payment_type, due_date, amount_paid_value, remaining_balance, student_id))
    ...
    def show_admitted_profile_panel():
        ...
        save_button = tk.Button(button_frame, text="Save", command=lambda: admitted_save_balance_data(admitted_selected_student[0]), 
        ...
        def admitted_save_balance_data(student_id):
            payment_type = payment_type_combobox.get().strip()
            balance_value = balance_entry.get().strip()
            amount_paid_value = amount_paying_entry.get().strip()
...
#=======================================================WINDOW + FRAMES + LAYOUT================================================
    ...
    def add_top_right_label(parent_frame):
        ...
        welcome_label = tk.Label(top_right_frame, text="CASHIER", font=('Arial', 14, 'bold'), bg="#0f1074", fg="#E4E6C9")
