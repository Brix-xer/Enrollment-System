...
#============================================UPDATE DATAGIRDVIEW CODE======================================
    ...
    def show_student_profile_panel():
        ...
        login_credentials_button.grid(row=6, column=1, padx=5, pady=5, sticky='w')
        ...
        save_button = tk.Button(button_frame, text="Save", command=lambda: save_student_data(selected_student[0]), font=('Arial', 12), bg="#27ae60", fg="#ffffff")
        save_button.pack(side=tk.LEFT, padx=10, pady=5)

        re_enroll_button = tk.Button(button_frame, text="Re-enroll", command=lambda: re_enroll_student(selected_student[0]), font=('Arial', 12), bg="#2980b9", fg="#ffffff")
        re_enroll_button.pack(side=tk.LEFT, padx=10, pady=5)
...
#=======================================================WINDOW + FRAMES + LAYOUT================================================
    ...
    main_root.title("Student Enrollment System")
    width = 1300
    height = 700
    ...
    def add_top_right_label(parent_frame):
        ...
        welcome_label = tk.Label(top_right_frame, text="REGISTRAR", font=('Arial', 14, 'bold'), bg="#0f1074", fg="#E4E6C9")
...
#====================================================== NEW USER PANEL ==============================================
    ...
    def create_horizontal_input_section(parent):
        ...
        role_combo = ttk.Combobox(input_frame, values=["Registrar", "Interviewer", "Teacher"], state="readonly", font=('Arial', 14), width=12)
    ...
    def create_table_section(parent):
        ...
        # User Table
        user_table = ttk.Treeview(table_frame, columns=("ID", "Username", "Role"), show="headings")
    ...
    def create_table_section(parent):
        """Creates the section displaying registered users."""
        global user_table
        table_frame = tk.Frame(parent, bg="#ecf0f1", padx=15, pady=10)
        table_frame.pack(fill="both", expand=True)
        user_table = ttk.Treeview(table_frame, columns=("ID", "Username", "Role"), show="headings")
